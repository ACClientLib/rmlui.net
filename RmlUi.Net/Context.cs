...
namespace RmlUiNet
{
    public class Context : RmlBase<Context>
    {
        ...
        public bool ProcessMouseWheel(Vector2f wheelDelta, int keyModifierState)
        {
            return Native.Context.ProcessMouseWheel(NativePtr, wheelDelta, keyModifierState);
        }
        ...
        /// <param name="keyModifierState">The state of key modifiers (shift, control, caps-lock, etc) keys; this should be generated by ORing together members of the Input::KeyModifier enumeration.</param>
        /// <returns>True if the event was not consumed (ie, was prevented from propagating by an element), false if it was.</returns>
        public bool ProcessKeyDown(Input.KeyIdentifier identifier, int keyModifierState)
        {
            return Native.Context.ProcessKeyDown(NativePtr, identifier, keyModifierState);
        }
        ...
        /// <param name="keyModifierState">The state of key modifiers (shift, control, caps-lock, etc) keys; this should be generated by ORing together members of the Input::KeyModifier enumeration.</param>
        /// <returns>True if the event was not consumed (ie, was prevented from propagating by an element), false if it was.</returns>
        public bool ProcessKeyUp(Input.KeyIdentifier identifier, int keyModifierState)
        {
            return Native.Context.ProcessKeyUp(NativePtr, identifier, keyModifierState);
        }
